    ...
    <div className={`${isDark ? "bg-black text-white" : "bg-white text-black"} py-20`} id="contact">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        <motion.h2
          ...
          className={`text-4xl font-bold text-center mb-12 ${isDark ? "text-white" : "text-black"}`}
        >
          Get in Touch
        </motion.h2>
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  name="user_name"
                  className={`w-full p-2 rounded ${isDark ? "bg-gray-800 text-white border-gray-600" : "bg-gray-200 text-black border-gray-400"} focus:outline-none focus:border-green-400`}
